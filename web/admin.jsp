    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
      ...
      <body>
        ...
        <nav class="navbar is-transparent  is-fixed-top">
          ...
          <form action="/grantServlet" method="post">
            <input type="submit" class="UESTCquanxian" style="display: none">
          </form>
      ...
      %>
        ...
        <div style="position: absolute;top: 41%;left: 40%;display: none;border:1px solid gray;border-radius:5px;margin: 30px;padding: 0 0 20px 30px"
          class="shouquanchuangkou">
          ...
          <div>请确认对
            <span class="quanxianName"></span>
            <span style="display: none" class="quanxianQ"></span>进行的权限操作</div>
          <br> &emsp;
