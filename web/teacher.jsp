      ...
      <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        %>
                      ...
                      <%}%>
                        &emsp;
                        <span>
                          <input type="text" class="input is-small" style="width: 40px;text-align: center;font-weight: 800;font-size: 14px;margin-top: -2px;"
                            value="<%=page1.getPageNow()%>">&emsp;/
                          <%=page1.getPageSum()%>&emsp;
